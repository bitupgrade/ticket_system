...
class PostCreateView(LoginRequiredMixin, CreateView): 
    model = Post
    fields = ['title', 'description', 'priority', 'status'] # Fields in the create post section
...
class PostUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView): 
    model = Post
    fields = ['title', 'description', 'priority', 'status'] # Fields in the update ticket section
